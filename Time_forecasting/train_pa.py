...
from net_convmultiwave2d_pa import conv2d_multiwave_pa
...
parser.add_argument('--patch_size_list', nargs='+', type=int, default=[24,12,8,4,12,8,6,4,8,6,4,2])
...
net=conv2d_multiwave_pa(args, args.seq_len, args.seq_len,output_size,mode='dot',factor=5, d_model=512, n_heads=4, d_layers=6,
                dropout=0.0, freq='h',model='lstm',d_prob=0.5,hidden_size=hd,batch_size1=32)
