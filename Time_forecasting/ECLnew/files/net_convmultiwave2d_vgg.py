...
class conv2d_multiwave_vgg(nn.Module):#三层小波分解
    def __init__(self,length_input = 96, number_ouputs=4,mode='dot',factor=5, d_model=512, n_heads=8, d_layers=2,
        ...
        super(conv2d_multiwave_vgg, self).__init__()   # 继承__init__功能 pytorch初始化参数
        ...
        self.vgg = VGG('VGG12',num_class=self.num_outputs)
