...
from net_convmultiwave2d_tsm import conv2d_multiwave_tsm
...
net=conv2d_multiwave_tsm(args, args.seq_len, args.seq_len,output_size,mode='dot',factor=5, d_model=512, n_heads=4, d_layers=args.num_layers, ratio=args.ratio,
