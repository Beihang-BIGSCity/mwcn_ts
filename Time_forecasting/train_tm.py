...
from net_convmultiwave2d_tm import conv2d_multiwave_tm
...
parser.add_argument('--hidden_size', type=int, default=64, help='numbers of lstm hidden size')
...
parser.add_argument('--dropout', type=float, default=0.0, help='train epochs')
parser.add_argument('--patience', type=int, default=10, help='early stopping patience')
parser.add_argument('--channel_independence', type=int, default=1,
                        help='0: channel dependence 1: channel independence for FreTS model')
parser.add_argument('--decomp_method', type=str, default='moving_avg')
parser.add_argument('--moving_avg', type=int, default=6, help='window size of moving average')
...
net=conv2d_multiwave_tm(args, args.seq_len, args.seq_len,output_size,mode='dot',factor=5, d_model=512, n_heads=4, d_layers=6,
                dropout=args.dropout, freq='h',model='lstm',d_prob=0.5,hidden_size=hd,batch_size1=32)
...
#        targets = targets.reshape(-1).long()
        ...
        loss = loss + loss2#+ orthogonal_regularization #if orthorgonal regularization
        loss.backward()
        optimizer.step()
