...
import numpy as np
from models.pathformer.layers.AMS import AMS
from models.pathformer.layers.Layer import WeightGenerator, CustomLinear
from models.pathformer.layers.RevIN import RevIN
from functools import reduce
from operator import mul


class PathFormer(nn.Module):
    def __init__(self, configs, seq_len, pred_len, d_model):
