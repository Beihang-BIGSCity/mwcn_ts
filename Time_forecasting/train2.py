...
net=conv2d_multiwave_vgg(args.seq_len, args.pred_len,output_size,factor=5, d_model=512, n_heads=2, d_layers=2,
                dropout=0.0, freq='h',model='vgg',d_prob=0.5,batch_size1=32)
