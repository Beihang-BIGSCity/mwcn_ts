...
class conv2d_multiwave_att5(nn.Module):#三层小波分解
    def __init__(self,length_input = 96, number_ouputs=4,mode='dot',factor=5, d_model=512, n_heads=8, d_layers=2,
        ...
        super(conv2d_multiwave_att5, self).__init__()   # 继承__init__功能 pytorch初始化参数
    ...
    def forward(self, x,mode='dot'):
        ...
        if self.model=='vgg':    
            ...
            #u = torch.stack([low1,high1,low2,high2,low3,high3],dim=1)
